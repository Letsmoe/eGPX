...
import * as dependency_3 from "./Waypoint";
...
export declare namespace eGPX {
    class File extends pb_1.Message {
        ...
        get wpt(): dependency_3.Waypoint[];
        set wpt(value: dependency_3.Waypoint[]);
        get trk(): Track[];
        set trk(value: Track[]);
        get rte(): Route[];
        set rte(value: Route[]);
        ...
        static fromObject(data: {
            ...
            wpt?: ReturnType<typeof dependency_3.Waypoint.prototype.toObject>[];
    ...
    class Route extends pb_1.Message {
        ...
        get extensions(): Map<string, dependency_1.google.protobuf.Any>;
        set extensions(value: Map<string, dependency_1.google.protobuf.Any>);
        get rtept(): dependency_3.Waypoint[];
        set rtept(value: dependency_3.Waypoint[]);
        static fromObject(data: {
            name?: string;
            cmt?: string;
            desc?: string;
            ...
            rtept?: ReturnType<typeof dependency_3.Waypoint.prototype.toObject>[];
        }): Route;
        toObject(): {
            name?: string | undefined;
            cmt?: string | undefined;
    ...
    class TrackSegment extends pb_1.Message {
        #private;
        constructor(data?: any[] | {
            trkpt?: dependency_3.Waypoint[];
            extensions?: Map<string, dependency_1.google.protobuf.Any>;
        });
        get trkpt(): dependency_3.Waypoint[];
        set trkpt(value: dependency_3.Waypoint[]);
        get extensions(): Map<string, dependency_1.google.protobuf.Any>;
        set extensions(value: Map<string, dependency_1.google.protobuf.Any>);
        static fromObject(data: {
            trkpt?: ReturnType<typeof dependency_3.Waypoint.prototype.toObject>[];
            extensions?: {
                [key: string]: ReturnType<typeof dependency_1.google.protobuf.Any.prototype.toObject>;
            };
        }): TrackSegment;
...
//# sourceMappingURL=eGPX-V1.1.d.ts.map